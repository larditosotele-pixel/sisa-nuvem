...
def exportar_mapeamento():
    ...
    cor_amb1 = PatternFill(start_color='C6E0B4', end_color='C6E0B4', fill_type='solid')
    cor_amb2_h = PatternFill(start_color='BDD7EE', end_color='BDD7EE', fill_type='solid')
    cor_amb2_m = PatternFill(start_color='F8CBAD', end_color='F8CBAD', fill_type='solid')
    cor_amb3_h = PatternFill(start_color='BDD7EE', end_color='BDD7EE', fill_type='solid')
    cor_amb3_m = PatternFill(start_color='A9D08E', end_color='A9D08E', fill_type='solid')
